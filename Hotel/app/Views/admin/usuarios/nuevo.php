            ...
            <div id="layoutSidenav_content">
            	<main>
                    <div class="container-fluid">
						...
						<?php if($_POST){ foreach ($user as $el){?>

	                        <ol class="breadcrumb mb-4">
	                            <li class="breadcrumb-item active">Administración/Sitio Web/Usuarios/Editar</li>
							</ol>
							<div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Formulario para Usuarios</div>
                            <div class="card-body">
                            ...
                            <form method="post" action="actualizar" enctype="multipart/form-data">              
                                ...
                                <div class="row">
                                    ...
                                    <a href="../Usuariosadmin" class="btn btn-danger">Cancelar</a>
                                </form>
						<?php };}else{?> 
                            
							<ol class="breadcrumb mb-4">
	                            <li class="breadcrumb-item active">Administración/Sitio Web/Usuarios/Nuevo</li>
							</ol>
							<div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>Formulario para Usuarios</div>
                            <div class="card-body">
