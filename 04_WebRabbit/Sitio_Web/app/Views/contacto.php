                ...
                <div class="col-lg-6">
                    <div class="contact-left">
                        <div class="contact-information">
                            ...
                            <ul>
                                <li><img src="<?= base_url('vendor/template/img/placeholder-copy.png')?>" alt=""> <span>1525 Boring Lane, Los Angeles,
                                        CA</span></li>
                                <li><img src="<?= base_url('vendor/template/img/phone-copy.png')?>" alt=""> <span>+1 (603)535-4592</span></li>
                                <li><img src="<?= base_url('vendor/template/img/envelop.png')?>" alt=""> <span>hello@youremail.com</span></li>
                                <li><img src="<?= base_url('vendor/template/img/clock-copy.png')?>" alt=""> <span>Everyday: 06:00 -22:00</span></li>
                            </ul>
                        </div>
