...
use App\Models\RecepcionistasModel;


class RecepcionistasController extends BaseController
{
	...
	{
		$recepcionistasModel= new RecepcionistasModel($db);
		$recepcionistas=$recepcionistasModel->findAll();
		$recepcionistas=array('recepcionistas' =>$recepcionistas );


		return view('templates\header').view('recepcionistas\RecepcionistasView',$recepcionistas).view('templates\footer');
	}
