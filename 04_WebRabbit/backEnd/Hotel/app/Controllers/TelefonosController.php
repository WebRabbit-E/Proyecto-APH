...
class TelefonosController extends BaseController
{
	...
	{
		$telefonosModel= new TelefonosModel($db);
		$telefonos=$telefonosModel->findAll();
		$telefonos=array('telefonos' =>$telefonos );


		return view('templates\header').view('telefonos\TelefonosView',$telefonos).view('templates\footer');
	}
