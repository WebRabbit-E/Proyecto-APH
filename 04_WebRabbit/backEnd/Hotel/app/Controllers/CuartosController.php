...
class CuartosController extends BaseController
{
	...
	{
		$cuartosModel= new CuartosModel($db);
		$cuartos=$cuartosModel->findAll();
		$cuartos=array('cuartos' =>$cuartos );


		return view('templates\header').view('cuartos\CuartosView',$cuartos).view('templates\footer');
	}
